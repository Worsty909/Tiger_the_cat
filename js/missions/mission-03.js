    ...
    scenes: [
      ...
      /* ====== 3. KRABICE (hádanka: mapa) ====== */
      {
        ...
        text: [
          ...
          'A fotky. Desítky malých fotek stejného kocoura, pokaždé rozmazaného, pokaždé zdálky.',
      ...
      /* ====== 6. 1961 — hlavní zvrat ====== */
      {
        ...
        text: [
          ...
          'Tři holčičky, tři generace, jeden obličej, sedmdesát let.',
      ...
      /* ====== 7. SKLEP ZA DNE ====== */
      {
        ...
        text: [
          ...
          { bertik: 'Ptal.' },
          { tiger: 'Sedmdesát let. A ta odpověď se ti nebude líbit, protože to nikdo nedělal mně.' },
      ...
      /* ====== 8. SKRÝŠE (hádanka: vzpomínání) ====== */
      {
        ...
        text: [
          ...
          'Plechovky. Řada za řadou, seřazené podle data. Nejnovější z letoška. Nejstarší tak stará, že se na ní nedalo přečíst vůbec nic.',
        ...
        puzzle: {
          ...
          questions: [
            ...
            },
            {
              ...
              answer: 2,
              say: 'Ema počítala na prstech. „Byly čtyři. Jeden na každý roh papíru."'
            },
            {
